...
public class swapRequestSubmittedToMeRec extends ARecord {
    ...
    public swapRequestSubmittedToMeRec(String _requestID, String _vacationID, Hyperlink _Hyl_sellerSideVacationDet,
