...
public class swapSearchResultsCol extends Acolumn {
    ...
    public swapSearchResultsCol(String _vacationID, String _from, String _destination, String _departDate, String _returnDate, String _supplierUserName, Hyperlink viewB, Button _switch){
