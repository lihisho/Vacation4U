...
public class purchaseRequestSubmittedToMeCol extends Acolumn{
    ...
    public purchaseRequestSubmittedToMeCol(String _purchaseRequestID, String _flightID, String _purchaserUserName, String _status, Hyperlink _flightDetails, Button _accept, Button _reject) {
