...
public class myPurchaseRequestRec extends ARecord {
    ...
    public myPurchaseRequestRec(String _orderID, String _flightID, String _status, Hyperlink _flightDetails, Button pay) {
